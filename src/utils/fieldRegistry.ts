...
export const FIELD_REGISTRY: Record<string, FieldRegistryItem> = {
  // General Tab Fields
  'emergency_contact_1_name': { sectionId: 'general', sectionTitle: 'General Information', required: true },
  'emergency_contact_1_relationship': { sectionId: 'general', sectionTitle: 'General Information', required: true },
  'emergency_contact_1_phone': { sectionId: 'general', sectionTitle: 'General Information', required: true },
  ...
  // Physical Tab Fields
  'current_complaint': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  'level_of_consciousness': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  ...
  'temperature': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  'temp_method': { sectionId: 'physical', sectionTitle: 'Physical Assessment' },
  'pulse': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  ...
  'bp_systolic': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  'bp_diastolic': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  ...
  'respiratory_rate': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
  'respiration_status': { sectionId: 'physical', sectionTitle: 'Physical Assessment' },
  'spo2': { sectionId: 'physical', sectionTitle: 'Physical Assessment', required: true },
