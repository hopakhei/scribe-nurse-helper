...
import { Mic, MicOff, Square, FileText, Loader2 } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              This transcript was used to automatically fill form fields above. You can edit any field manually if needed.
            </p>
          </CardContent>
        </Card>
      )}
