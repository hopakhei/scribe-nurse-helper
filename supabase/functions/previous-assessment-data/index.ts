...
function getPatientSpecificData(patientId: string) {
  const specificPatients: Record<string, any> = {
    ...
    'd5555555-5555-5555-5555-555555555555': {
      ...
      current_medications: "Metformin 850mg BD, Amlodipine 5mg OD, Paracetamol PRN",
      past_medical_history: "T2DM since 2019, Hypertension since 2017, Osteoarthritis of knees",
      mobility: "Walking with stick",
      fall_risk: "Moderate risk",
      cognitive_status: "Alert and oriented x3",
      diet: "Diabetic diet",
      functional_status: "Independent in ADLs, uses walking stick for mobility",
      pain_level: "3/10 knee pain (osteoarthritis)",
      wound_status: "No active wounds",
      marital_status: "Widowed",
      religion: "Buddhism",
      education: "Secondary",
      ...
      occupation: "Clerk",
      financial_support: "Family",
      accommodation: "Flat (no elevator, 2nd floor)",
      nationality: "Hong Kong Chinese",
      household_members: "Son visits daily, Daughter visits weekly",
      smoking_status: "Non-smoker",
      drinking_status: "Non-drinker",
      substance_status: "Non-user",
      primary_language: "Cantonese",
      dialect: "Cantonese",
      communication_barriers: "Mild hearing impairment",
      hearing_aids: "No, but recommended",
      visual_aids: "Reading glasses",
      speech_difficulties: "None",
      hearing_status: "Mild impairment",
      speech_status: "Clear",
      vision_status: "Wears reading glasses",
      appetite: "Good",
      dietary_restrictions: "Diabetic diet",
      bowel_pattern: "Regular, daily",
      urinary_pattern: "Normal frequency",
      last_admission_date: "2025-06-15",
      last_discharge_date: "2025-06-28"
    }
  };
