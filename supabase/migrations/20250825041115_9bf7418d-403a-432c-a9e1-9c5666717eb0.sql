...
('Sarah Johnson', 'H001234', 'ID001234', 'F', 65, 'Internal Medicine', 'Ward 3A', 'Team Alpha', 'emergency', CURRENT_DATE, NULL, 'awaiting_bed', NULL, NULL),
('Michael Chen', 'H001235', 'ID001235', 'M', 58, 'Internal Medicine', 'Ward 3A', 'Team Beta', 'scheduled', CURRENT_DATE, '3A-05', 'bed_assigned', 'robot', NOW() - INTERVAL '30 minutes'),
('Emily Davis', 'H001236', 'ID001236', 'F', 42, 'Internal Medicine', 'Ward 3B', 'Team Alpha', 'emergency', CURRENT_DATE, '3B-12', 'assessment_in_progress', 'robot', NOW() - INTERVAL '2 hours'),
...
('Anna Garcia', 'H001238', 'ID001238', 'F', 34, 'Internal Medicine', 'Ward 3B', 'Team Alpha', 'scheduled', CURRENT_DATE, '3B-08', 'assessment_completed', 'robot', NOW() - INTERVAL '4 hours');

-- Update existing assessments to link to patients
UPDATE public.patient_assessments 
SET patient_id = (SELECT id FROM public.patients WHERE name = 'Emily Davis' LIMIT 1)
